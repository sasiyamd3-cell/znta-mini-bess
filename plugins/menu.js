...
async (zanta, mek, m, { from, reply, args, userSettings, pushname }) => {
    try {
        ...
        // --- 📊 කැටගරි ලිස්ට් එක (අලුත් ඒවා ඇතුළුව) ---
        const groupedCommands = {};
        
        // උඹ ඉල්ලපු games සහ movie කැටගරි දෙකත් එක්ක default ලිස්ට් එක හැදුවා මචන්
        ...
        if (selectedCategory && groupedCommands[selectedCategory]) {
            ...
            // අලුත් කැටගරි වලට සුපිරිම ඉමෝජි සෙට් කරා
            let emoji = { 
        ...
        if (isButtonsOn) {
            ...
            await sendButtons(zanta, from, {
                ...
                buttons: [
                    ...
                    { id: 'cat_games', text: '🎮 ɢᴀᴍᴇ ᴅʟ' },  // Game DL Button එක
                    { id: 'cat_movie', text: '🎬 ᴍᴏᴠɪᴇ ᴅʟ' },  // Movie DL Button එක
